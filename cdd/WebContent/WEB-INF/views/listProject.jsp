...
<script type="text/javascript">
      ...
      function drawChart() {
    	  var jsonData = ${jsonDataChartSubTrack};
	...
	<header class="head">
		<%-- <div>
			<div id="contentHead" class="contentHead">
				<span id="contentHeadInner">${subtrackName}</span>
			</div>
		</div> --%>
		...
		<div>
			<div class="main-bar">
				...
				<ul id="tsc_breadcrumb-4">
					...
					<li><a class="current">${subtrackName}</a></li>
				</ul>
			</div>
		</div>
								...
								<tbody>
									<c:forEach items="${projectListBean}" var="projectListBean">
										<tr>
											...
											<td><spring:url
													value="/projectInfo/{groupId}/{groupName}/{trackId}/{trackName}/{subtrackId}/{subtrackName}/{projectId}/{projectName}"
													var="goToUrl">
													<spring:param name="groupId" value="${groupId}" />
													<spring:param name="groupName" value="${groupName}" />
													<spring:param name="trackId" value="${trackId}" />
											...
											<td align="center"><c:choose>
													...
													<c:otherwise>
														...
														<c:choose>
															...
															src="${pageContext.request.contextPath}/resources/images/red.png">
															</c:when>
															<c:when
																test="${projectListBean.quality_index == 'yellow'}">
																<img height="21px" width="30px"
															src="${pageContext.request.contextPath}/resources/images/yellow.png">
															</c:when>
															<c:otherwise>
																<img height="21px" width="30px"
