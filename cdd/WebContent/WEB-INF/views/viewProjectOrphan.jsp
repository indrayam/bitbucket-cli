...
<!-- <script>
        window.onload = function() {     
        	var el = document.getElementById('contentHead');   
        	while(((document.getElementById("contentHead").offsetWidth)-30) != document.getElementById("contentHeadInner").offsetWidth){
        		
            	var style = window.getComputedStyle(el, null).getPropertyValue('font-size');
            	var fontSize = parseFloat(style);
        		el.style.fontSize = (fontSize - 1) + 'px';
        		var styleP = window.getComputedStyle(el, null).getPropertyValue('padding-top');
            	var pad = parseFloat(styleP);
        		el.style.paddingTop = (pad + 0.5) + 'px';
           	}
        	
        	while(document.getElementById("breadcrumb").offsetWidth > 750){
        		var style = window.getComputedStyle(document.getElementById("breadcrumb"), null).getPropertyValue('font-size');
            	var fontSize = parseFloat(style);
        		document.getElementById("breadcrumb").style.fontSize = (fontSize - 1) + 'px';
        	}
        }
    </script> -->
</head>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="box">
						...
						<p align="center" style="margin:0px">* Since first build</p>
					</div>
				</div>
						...
						<div class="small-box bg-red">
							<div class="inner innerBorder"
								...
								<c:choose>
									...
									<c:otherwise>
									<a href="https://csqi.cisco.com/drilldown/measures/${metricsBean.sonar_key}?metric=coverage" style="color: white;" target="_blank">	<h3>${metricsBean.unit_test_coverage}%</h3> </a>
									</c:otherwise>
								</c:choose>
				...
				<ul class="stats_box">
					<li>
						...
						<div class="stat_text">
							...
							<div class="percent down">
								<div>
									<a href="https://csqi.cisco.com/drilldown/measures/${metricsBean.sonar_key}?metric=ncloc" style="color: #008080;" target="_blank">${metricsBean.lines_of_code}</a>
								</div>
							</div>
					...
					<li>
						...
						<div class="stat_text">
							...
							<div class="percent down">
								<div><a href="https://csqi.cisco.com/drilldown/measures/${metricsBean.sonar_key}?highlight=duplicated_lines_density&metric=duplicated_lines" style="color: #008080;" target="_blank">${metricsBean.duplication}</a></div>
							</div>
							<div class="myTooltip2" title="Help">
								<a data-toggle="modal" data-original-title="Help"
										data-placement="bottom" class="myTooltip2A"
					...
					<li>
						...
						<div class="stat_text">
							...
							<div class="percent down">
								<div><a href="https://csqi.cisco.com/drilldown/measures/${metricsBean.sonar_key}?metric=function_complexity" style="color: #008080;" target="_blank">${metricsBean.complexity_per_function}</a></div>
							</div>
							<div class="myTooltip2" title="Help">
								<a data-toggle="modal" data-original-title="Help"
										data-placement="bottom" class="myTooltip2A"
					...
					<li>
						...
						<div class="stat_text">
							...
							<div class="percent down">
								<div><a href="https://csqi.cisco.com/drilldown/measures/${metricsBean.sonar_key}?metric=comment_lines_density" style="color: #008080;" target="_blank">${metricsBean.comments}</a></div>
							</div>
							<div class="myTooltip2" title="Help">
								<a data-toggle="modal" data-original-title="Help"
										data-placement="bottom" class="myTooltip2A"
